...
func TestLines(t *testing.T) {
	...
	lines := iter.Collect[Result[[]byte]](iter.Lines(file))
...
func TestLinesEmpty(t *testing.T) {
	lines := iter.Collect[Result[[]byte]](iter.Lines(new(bytes.Buffer)))
...
func TestLinesFailure(t *testing.T) {
	...
	lines := iter.Collect[Result[[]byte]](iter.Lines(reader))
...
func TestLinesString(t *testing.T) {
	...
	lines := iter.Collect[Result[string]](iter.LinesString(file))
...
func TestLinesStringEmpty(t *testing.T) {
	lines := iter.Collect[Result[string]](iter.LinesString(new(bytes.Buffer)))
...
func TestLinesStringFailure(t *testing.T) {
	reader := newFakeReader(readResult{make([]byte, 0), errors.New("oops")})
	lines := iter.Collect[Result[string]](iter.LinesString(reader))
